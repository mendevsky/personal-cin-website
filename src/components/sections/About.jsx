                ...
                <p className="text-7xl font-bold mb-10 bg-gradient-to-r from-red-900 to-red-900 bg-clip-text text-transparent">
                  ...
                  <div className="flex justify-center items-center mt-10">
                    <a href="https://www.python.org/" target="_blank" rel="noopener noreferrer" className="animate-bounce">
                        <FaPython size={50} className="text-red-900 hover:text-red-600 transition-colors duration-300" />
                    </a>
                    <a href="https://www.linux.org/" target="_blank" rel="noopener noreferrer" className="animate-bounce ml-4">
                        <FaLinux size={50} className="text-red-900 hover:text-red-600 transition-colors duration-300" />
                    </a>
                    <a href="https://reactjs.org/" target="_blank" rel="noopener noreferrer" className="animate-bounce ml-4">
                        <RiReactjsFill size={50} className="text-red-900 hover:text-red-600 transition-colors duration-300" />
                    </a>
                    <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript" target="_blank" rel="noopener noreferrer" className="animate-bounce ml-4">
                        <FaJsSquare size={50} className="text-red-900 hover:text-red-600 transition-colors duration-300" />
                    </a>
                    <a href="https://github.com/" target="_blank" rel="noopener noreferrer" className="animate-bounce ml-4">
                        <FaGithub size={50} className="text-red-900 hover:text-red-600 transition-colors duration-300" />
                    </a>
                    <a href="https://www.java.com/" target="_blank" rel="noopener noreferrer" className="animate-bounce ml-4">
                        <FaJava size={50} className="text-red-900 hover:text-red-600 transition-colors duration-300" />
                    </a>
                  ...
                  <div className="flex justify-center items-center mt-10">
                    <a href="https://www.critrole.com/" target="_blank" rel="noopener noreferrer" className="animate-bounce">
                        <FaCriticalRole size={50} className="text-red-900 hover:text-red-600 transition-colors duration-300" />
                    </a>

                    <a href="https://dungeonsanddragons.com/" target="_blank" rel="noopener noreferrer" className="animate-bounce ml-4">
                        <SiDungeonsanddragons size={50} className="text-red-900 hover:text-red-600 transition-colors duration-300" />
                    </a>
                    <a href="https://store.steampowered.com/" target="_blank" rel="noopener noreferrer" className="animate-bounce ml-4">
                        <FaSteam size={50} className="text-red-900 hover:text-red-600 transition-colors duration-300" />
                    </a>
                    <a href="https://www.nasa.gov/" target="_blank" rel="noopener noreferrer" className="animate-bounce ml-4">
                        <SiNasa size={50} className="text-red-900 hover:text-red-600 transition-colors duration-300" />
                    </a>
                    <a href="https://www.goodreads.com/" target="_blank" rel="noopener noreferrer" className="animate-bounce ml-4">
                        <GiBookCover size={50} className="text-red-900 hover:text-red-600 transition-colors duration-300" />
                    </a>
